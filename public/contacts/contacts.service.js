    ...
    function Contacts(googleApiConnection,$filter) {
        ...
        self.getGroups = function getGroups (params){
         ...
         self.creataContact = function createContact(contact){
            //var contact = self.jsonContactToAtom(contact);
            var string = "<atom:entry xmlns:atom='http://www.w3.org/2005/Atom'xmlns:gd='http://schemas.google.com/g/2005'> <atom:category scheme='http://schemas.google.com/g/2005#kind'term='http://schemas.google.com/contact/2008#contact'/> <gd:name> <gd:givenName>Demo</gd:givenName> <gd:familyName>Sadan Stock</gd:familyName> <gd:fullName>Demo Sadan Stock</gd:fullName> </gd:name></atom:entry>"//create headers
            return googleApiConnection.create(string);
           /* var text = "<atom:entry xmlns:atom='http://www.w3.org/2005/Atom'
